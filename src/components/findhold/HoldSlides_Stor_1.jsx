...
import { Action } from '../../data/HoldData';

const HoldSlides_Stor_1 = ({ title }) => {
  const responsive = {
    desktop: {
  ...
  return (
    <div className="HoldSlides" aria-label={title}>
      ...
      <Carousel
        ...
        aria-hidden={false}
      >
        {Action.map((hold, index) => (
          <div key={index} className="carousel-thumbnail" aria-label={hold.title}>
...
export default HoldSlides_Stor_1;
