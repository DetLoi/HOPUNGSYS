...
const HoldSlides_0 = ({ title, animate }) => {
  const responsive = {
    desktop: {
  ...
  return (
    <div className={`HoldSlides ${animate ? 'fade-in-right-effect' : ''}`} aria-label={title}>
